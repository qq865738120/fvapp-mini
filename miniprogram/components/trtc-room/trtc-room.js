  ...
  lifetimes: {
    ...
    ready: function() {
      ...
      this.infoListTouchEvent.bind({//初始化后绑定事件
        tap: (e) => {
          this.triggerEvent('ontap', e, { bubbles: true });
        },
        swipe: (e) => {
          this.triggerEvent('swipe', e, { bubbles: true });
        },
        rotate: (e) => {
          this.triggerEvent('rotate', e, { bubbles: true });
        },
        pinch: (e) => {
          this.triggerEvent('pinch', e, { bubbles: true });
        },
        touchMove: (e) => {
          this.triggerEvent('move', e, { bubbles: true });
        },
        doubleTap: (e) => {
          this.triggerEvent('ondoubletap', e, { bubbles: true })
        }
      })
    },
    detached: function() {
